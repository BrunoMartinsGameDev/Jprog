    ...
    if(questao.isdigit()):
        if(int(questao) >= 1 and int(questao) <= 12):
            match int(questao):
                ...
                case 4: questao4(2, 0, 16) # questao4(a, b, c)
                case 5: questao5() 
                case 6: questao6( 80000, 0.03, 200000, 0.015) # questao6(populacao_A, taxa_A, populacao_B, taxa_B)
                case 7: questao7(10) # questao7(n)
